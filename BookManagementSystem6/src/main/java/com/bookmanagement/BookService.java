...
public class BookService {
        ...
        try {
            ...
            while (flag) {
                ...
                if (author.isEmpty()) {
                    ...
                    session.insert("AuthorMapper.insert", newAuthor);
                    newBook.addAuthor(newAuthor);
                }
            }
        } catch (Exception e) {
            session.rollback();
            throw new RuntimeException("Error occurred during insertion", e);
        }
    }
    ...
    public Author getAuthorByID(int id) {
        return(session.selectOne("AuthorMapper.getById", id));
    }

    public List<Author> getAuthorsByBookID(int id) {
        return(session.selectList("AuthorMapper.getByBookId", id));
    }
    ...
    public void updateAuthor(int id) {
        ...
        if (existAuthor == null) {
            ...
            // We can leave id unchanged.
            session.update("AuthorMapper.update", existAuthor);
        }
    }
}